...
def five_crop(img, size):
    ...
    br = crop(img, image_width - crop_width, image_height -
              crop_height, image_width, image_height)
...
def _blend(img1, img2, ratio):
    ...
    bound = 1 if img1.dtype in [torch.half,
                                torch.float32, torch.float64] else 255
